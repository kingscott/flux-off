...
var CompositeLoader = _ComponentsIndex2['default'].CompositeLoader;
...
var App = _react2['default'].createClass({
  ...
  render: function render() {
    ...
    console.log(this.state.composite);
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement('br', null),
      _react2['default'].createElement(CompositeLoader, { composite: this.state.composite, 'import': _ComponentsIndex2['default'] })
    );
  },
